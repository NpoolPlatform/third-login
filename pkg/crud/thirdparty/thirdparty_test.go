...
func TestCRUD(t *testing.T) {
	...
	infos, err = schema.CreateBulk(context.Background(), []*npool.ThirdParty{thirdAuth1, thirdAuth2})
	if assert.Nil(t, err) {
