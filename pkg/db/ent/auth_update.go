...
func (au *AuthUpdate) SetThirdPartyID(u uuid.UUID) *AuthUpdate {
	au.mutation.SetThirdPartyID(u)
	return au
}

// SetAppKey sets the "app_key" field.
func (au *AuthUpdate) SetAppKey(s string) *AuthUpdate {
	au.mutation.SetAppKey(s)
	return au
}

// SetAppSecret sets the "app_secret" field.
func (au *AuthUpdate) SetAppSecret(s string) *AuthUpdate {
	au.mutation.SetAppSecret(s)
	return au
}

// SetRedirectURL sets the "redirect_url" field.
func (au *AuthUpdate) SetRedirectURL(s string) *AuthUpdate {
...
func (au *AuthUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := au.mutation.ThirdPartyID(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeUUID,
			Value:  value,
...
// SetThirdPartyID sets the "third_party_id" field.
func (auo *AuthUpdateOne) SetThirdPartyID(u uuid.UUID) *AuthUpdateOne {
	auo.mutation.SetThirdPartyID(u)
	return auo
}

// SetAppKey sets the "app_key" field.
func (auo *AuthUpdateOne) SetAppKey(s string) *AuthUpdateOne {
	auo.mutation.SetAppKey(s)
	return auo
}

// SetAppSecret sets the "app_secret" field.
func (auo *AuthUpdateOne) SetAppSecret(s string) *AuthUpdateOne {
	auo.mutation.SetAppSecret(s)
	return auo
}

// SetRedirectURL sets the "redirect_url" field.
func (auo *AuthUpdateOne) SetRedirectURL(s string) *AuthUpdateOne {
...
func (auo *AuthUpdateOne) sqlSave(ctx context.Context) (_node *Auth, err error) {
	...
	if value, ok := auo.mutation.ThirdPartyID(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeUUID,
			Value:  value,
			Column: auth.FieldThirdPartyID,
