...
func (*Auth) scanValues(columns []string) ([]interface{}, error) {
	...
	for i := range columns {
		...
		case auth.FieldAppKey, auth.FieldAppSecret, auth.FieldRedirectURL:
			values[i] = new(sql.NullString)
		case auth.FieldID, auth.FieldAppID, auth.FieldThirdPartyID:
...
func (a *Auth) String() string {
	...
	builder.WriteString(fmt.Sprintf("%v", a.ThirdPartyID))
